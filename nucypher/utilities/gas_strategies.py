...
def construct_datafeed_median_strategy(speed: Optional[str] = None) -> Callable:
    def datafeed_median_gas_price_strategy(web3: Web3, transaction_params: TxParams = None) -> Wei:
        # feeds = (CheapfastGasPriceDatafeed, CheapfastGasPriceDatafeed2, UpvestGasPriceDatafeed, EtherchainGasPriceDatafeed, ZoltuGasPriceDatafeed)
        feeds = (CheapfastGasPriceDatafeed, )
